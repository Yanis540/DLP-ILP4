...
implements IASTvisitor<Object, ILexicalEnvironment, EvaluationException>  {
    ...
    @Override
    public Object visit(IASTliste iast, ILexicalEnvironment data) throws EvaluationException {
        return 1; 
    }

    @Override
    public Object visit(IASTlisteRange iast, ILexicalEnvironment data) throws EvaluationException {
        return 1; 
    }
