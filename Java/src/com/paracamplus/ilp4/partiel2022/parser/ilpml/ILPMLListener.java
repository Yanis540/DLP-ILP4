package com.paracamplus.ilp4.partiel2022.parser.ilpml;
...
import antlr4.ILPMLgrammarPartiel2022Listener;
import antlr4.ILPMLgrammarPartiel2022Parser.ListeContext;
import antlr4.ILPMLgrammarPartiel2022Parser.ListeRangeContext;

import static antlr4.ILPMLgrammarPartiel2022Parser.*;
public class ILPMLListener implements ILPMLgrammarPartiel2022Listener {
    ...
    @Override
    public void enterListe(ListeContext ctx) {
    }

    @Override
    public void exitListe(ListeContext ctx) {
        ctx.node = factory.newListe(toExpressions(ctx.exprs));
    }

    @Override
    public void enterListeRange(ListeRangeContext ctx) {
    }

    @Override
    public void exitListeRange(ListeRangeContext ctx) {
        IASTexpression condition = null;
		
		if (ctx.condition != null) condition = ctx.condition.node;
        ctx.node =factory.newListeRange(ctx.body.node,
