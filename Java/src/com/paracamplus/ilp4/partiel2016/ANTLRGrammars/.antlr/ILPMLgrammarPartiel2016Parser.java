...
public class ILPMLgrammarPartiel2016Parser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, IDENT=48, INT=49, FLOAT=50, STRING=51, ESC=52, LINE_COMMENT=53, 
		COMMENT=54, SPACE=55;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'('", "')'", "'function'", "'&keys'", "'self'", "'super'", "'.'", "'new'", 
			"':'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'<'", "'<='", "'>'", 
			"'>='", "'=='", "'!='", "'&'", "'|'", "'^'", "'true'", "'false'", "'let'", 
			"'='", "'and'", "'in'", "'if'", "'then'", "'else'", "'while'", "'do'", 
			"'try'", "'catch'", "'finally'", "'lambda'"
		};
	}
	...
	public ILPMLgrammarPartiel2016Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		public com.paracamplus.ilp4.partiel2016.interfaces.IASTprogram node;
		public GlobalDefContext globalDef;
		public List<GlobalDefContext> defs = new ArrayList<GlobalDefContext>();
		public ExprContext expr;
		public List<ExprContext> exprs = new ArrayList<ExprContext>();
		public TerminalNode EOF() { return getToken(ILPMLgrammarPartiel2016Parser.EOF, 0); }
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4385462257805824L) != 0)) {
				{
				{
				setState(23);
	...
	public static class ClassDefContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENT() { return getTokens(ILPMLgrammarPartiel2016Parser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(ILPMLgrammarPartiel2016Parser.IDENT, i);
		}
	...
	public static class GlobalFunDefContext extends ParserRuleContext {
		...
		public List<Token> optionalVars = new ArrayList<Token>();
		public ExprContext expr;
		public List<ExprContext> defaultValues = new ArrayList<ExprContext>();
		public ExprContext body;
		public List<TerminalNode> IDENT() { return getTokens(ILPMLgrammarPartiel2016Parser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(ILPMLgrammarPartiel2016Parser.IDENT, i);
	...
	public final GlobalFunDefContext globalFunDef() throws RecognitionException {
		...
		try {
			...
			if (_la==T__11) {
				{
				setState(100);
				((GlobalFunDefContext)_localctx).optional = match(T__11);
				setState(101);
				((GlobalFunDefContext)_localctx).IDENT = match(IDENT);
				((GlobalFunDefContext)_localctx).optionalVars.add(((GlobalFunDefContext)_localctx).IDENT);
				setState(102);
				((GlobalFunDefContext)_localctx).expr = expr(0);
				((GlobalFunDefContext)_localctx).defaultValues.add(((GlobalFunDefContext)_localctx).expr);
				setState(108);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__5) {
	...
	public static class NewContext extends ExprContext {
		...
		public TerminalNode IDENT() { return getToken(ILPMLgrammarPartiel2016Parser.IDENT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class InvocationContext extends ExprContext {
		...
		public Token IDENT;
		public List<Token> optionalVars = new ArrayList<Token>();
		public List<ExprContext> optionalArgs = new ArrayList<ExprContext>();
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class ConstFloatContext extends ExprContext {
		...
		public TerminalNode FLOAT() { return getToken(ILPMLgrammarPartiel2016Parser.FLOAT, 0); }
	...
	public static class ConstIntegerContext extends ExprContext {
		...
		public TerminalNode INT() { return getToken(ILPMLgrammarPartiel2016Parser.INT, 0); }
	...
	public static class ConstStringContext extends ExprContext {
		...
		public TerminalNode STRING() { return getToken(ILPMLgrammarPartiel2016Parser.STRING, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4385462257805824L) != 0)) {
					{
					setState(154);
				...
				if ( _alt==1 ) {
					...
					case 10:
						...
						if (_la==T__16) {
							...
							((InvocationContext)_localctx).optionalVars.add(((InvocationContext)_localctx).IDENT);
							setState(300);
							((InvocationContext)_localctx).expr = expr(0);
							((InvocationContext)_localctx).optionalArgs.add(((InvocationContext)_localctx).expr);
							setState(307);
							_errHandler.sync(this);
							_la = _input.LA(1);
							while (_la==T__5) {
